...
const AppShell = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      <TopBar />
      <div className="mx-auto flex w-full max-w-[1400px] gap-5 px-4 pt-[72px] lg:gap-6 lg:px-6">
        <SectionsPanel />
        <main
          className={`mx-auto w-full max-w-md flex-1 lg:mx-0 lg:max-w-none ${hideTabBar ? "pb-[120px]" : "pb-28"} lg:pb-10`}
        >
          <Outlet />
        </main>
