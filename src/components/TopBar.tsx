      ...
      <div className="mx-auto flex max-w-md items-center justify-between px-4 py-2">
        <Link to="/" className="flex items-center gap-2.5">
          <div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-primary-soft">
            <img src={reefLogo} alt="" width={32} height={32} className="h-6 w-6 object-contain" />
          </div>
        ...
        <Link
          ...
          aria-label="السلة"
          dir="rtl"
          className="relative flex flex-row-reverse items-center gap-2 rounded-full bg-foreground/[0.06] px-2 py-1.5 transition hover:bg-foreground/[0.1] ease-apple"
        >
