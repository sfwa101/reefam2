          ...
          <div className="relative">
            ...
            {qty === 0 ? (
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-none bg-primary text-primary-foreground shadow-pill transition ease-apple active:scale-90"
              >
                <Plus className="h-4 w-4" strokeWidth={3} />
              </button>
            ) : (
              <div className="animate-qty-capsule flex h-9 items-center gap-1 rounded-none bg-primary text-primary-foreground shadow-pill">
                <button
                  onClick={handleDec}
                  aria-label="إنقاص"
                  className="flex h-9 w-8 items-center justify-center rounded-none transition ease-apple active:scale-90"
                >
